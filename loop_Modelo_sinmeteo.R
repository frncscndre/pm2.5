...
for(i in 1:100) {
  ...
  data <- subset(dataa, PM2.5!="NA" & PM2.5<110, select = c(PM2.5, TOA.B1, TOA.B2, TOA.B3, TOA.B4, TOA.B5, TOA.B6, TOA.B7,
  ...
  model %>% 
    layer_dense(units = 240, activation = 'relu', input_shape = c(14)) %>%
  ...
  setwd("C:/Users/Dell 2/Desktop/Modelos_SM")
    model %>% save_model_hdf5(file=paste("Modelo_SM", r, sep=""))
